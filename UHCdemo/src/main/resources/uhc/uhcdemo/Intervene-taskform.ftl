<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("PatientOut");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid PatientOut");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: UHCdemo.Intervene
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">PatientIn</label>
                            		<div class="div_checkbox">
                              		${PatientIn}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">PatientOut</label>
                            		<div class="div_texbox">
                              		<input name="PatientOut" type="text" class="textbox" id="PatientOut" value="${PatientOut}" />
                            		</div>
